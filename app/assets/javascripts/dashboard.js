window.onload = function() {
  ...
  Interest.urls = {
    create: {
      path: "/real_charts/nil/activities.json",
      method: 'post'
    }
  };
  ...
  var dataPointsIdeal = [{
    y: gon.idealchart.health_score,
    indexLabel: "Health",
    activity: gon.idealHealthInterests
  }, {
    y: gon.idealchart.social_score,
    indexLabel: "Social",
    activity: gon.idealSocialInterests
  }, {
    y: gon.idealchart.intellect_score,
    indexLabel: "Intellect",
    activity: gon.idealIntellectInterests
  }];
  ...
  CanvasJS.addColorSet("ourShades", [ //colorSet Array
    "#f1c40f",
    "#2ecc71",
    "#8e44ad"
  ]);
  ...
  var dataPointsReal = [{
    y: gon.realSocialActivitesCount,
    indexLabel: "Health",
    activity: gon.realHealthActivites
  }, {
    y: gon.realHealthActivitesCount,
    indexLabel: "Social",
    activity: gon.realSocialActivites
  }, {
    y: gon.realIntellectActivitesCount,
    indexLabel: "Intellect",
    activity: gon.realIntellectActivites
  }];
